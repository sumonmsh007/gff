<?php 
if(!function_exists('newsphere_by_author')){
    function newsphere_by_author(){
        global $post;
            ...
            if(isset($awpa_post_authors) && !empty($awpa_post_authors && $multiauthor_settings == true)){
                foreach ($awpa_post_authors as $key=>$author_id) {
                    ...
                    if (strpos($author_id, $needle) !== false) {
                     ...
                     newsphere_author_list($post_id,$author_id,$author_type, $author_avatar=false);
...
if(!function_exists('newsphere_author_list')){
function newsphere_author_list($post_id='',$author_id='',$author_type='',$author_avatar=false){
